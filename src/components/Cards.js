    ...
    return (
        <div className='card-wrapper mr-5'>
            ...
            <div className='task-holder'>
                <span className='card-header' style={{"backgroundColor":colors[index%5].secondaryColor,"border-radius":"10px"}}>{taskObj.Name}</span>
                <p className='pt-3'>{taskObj.Description}</p>
